package net.splodgebox.spookymobs.utils.nbt.utils;
...
import static net.splodgebox.spookymobs.utils.nbt.utils.MinecraftVersion.logger;
...
public class ApiMetricsLite {
	...
	private static final String PLUGINVERSION = "2.1.0"; // In case you fork the nbt-api for internal use in your network, plugins and so on, you *may* add that to the version here. (2.x.x-Timolia or something like that?)
